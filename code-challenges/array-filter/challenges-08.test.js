...
const filterStringsWithVowels = (arr) => arr.filter(i => i.match(/[aeiou]/));
...
const getBaseStatGreaterThan = (arr, minBaseStat) => arr.filter(i => (i.baseStat > minBaseStat));
...
const getCharactersWithoutChildren = (arr) => arr.filter(i => !(i.children));
